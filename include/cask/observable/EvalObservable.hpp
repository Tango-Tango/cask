...
template <class T, class E> class EvalObservable final : public Observable<T, E> {
public:
...
template <class T, class E>
FiberRef<None, None> EvalObservable<T, E>::subscribe(const std::shared_ptr<Scheduler>& sched,
